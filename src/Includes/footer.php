...
<footer class="relative bg-blueGray-200 pt-8 pb-6">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap text-left lg:text-left">
            <div class="w-full lg:w-6/12 px-4 pl-36">
                <h4 class="text-3xl fonat-semibold text-blueGray-700">Restons en contact !</h4>
                <h5 class="text-lg mt-0 mb-2 text-blueGray-600">
                    Retrouvez-nous sur nos autres plateformes !
                </h5>
                ...
                <div class="flex flex-wrap items-top mb-6">
                    <div class="w-full lg:w-4/12 px-4 ml-auto">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/presentation?ref=njs-profile">Nos infos</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/bootstrap-themes/free?ref=njs-profile">Produits gratuits</a>
                            </li>
                        </ul>
                    </div>
                    <div class="w-full lg:w-4/12 px-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://creative-tim.com/contact-us?ref=njs-profile">Nous contacter</a>
                            </li>
                        </ul>
                    </div>
                </div>
