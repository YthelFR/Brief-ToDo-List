<!-- REGISTER -->
<div id="registerBar" class="hidden formRegister right-0 bg-white w-80 my-5 shadow-md">
    <div class="py-8 px-8 rounded-xl">
        ...
        <div action="" class="mt-6">
            ...
            <div class="my-5 text-sm">
                ...
                <input class="confirm rounded-sm px-4 py-3 mt-3 focus:outline-none bg-gray-100 w-full" type="text" name="confirm" id="confirm" placeholder="Confirmer le mot de passe" />
            </div>

            <button id="btn-inscription" onclick="handleRegister()" type="submit" name="submit" class="w-full mt-6 bg-indigo-600 rounded-lg px-4 py-2 text-lg text-white tracking-wide font-semibold font-sans">S'inscrire</button>
